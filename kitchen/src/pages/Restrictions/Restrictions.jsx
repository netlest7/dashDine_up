            ...
            <div className='w-screen h-screen  bg-[#FFFFF] relative p-10 pb-32'>
                 <img src={circlebg} className='w-[300px] h-[300px] absolute left-0 top-0 z-1 '/>
                   ...
                   <div className='flex justify-between z-30 items-center z-20'>
                    ...
                    <SelectContent>
                        {storeFoodCategory.map((category,index)=>(
                ...
                <ScrollArea className="h-full w-full rounded-md border p-4 ">
                 
                    {
                        ...
                        items.map((item,index)=>(
                            <FoodItemComponent key={index} item_name={item.item_name} item_photo={item.item_photo.url} item_available={item.item_available} item_category={item.item_category}
